...
public class JPPlayGround extends javax.swing.JPanel {
    ...
    private void endGame(int state){
        ...
        if(state==SUCCESS){
            ...
            if(stageNo==6){
                returnV=JOptionPane.showConfirmDialog(this, "Finished all Stages !!, Do you want to Restart Game ?", "Success", JOptionPane.YES_NO_OPTION);
                if(returnV==1){
                    stopApplication();
                }else{
                    //Restart Game 
        ...
        jt.addKeyListener(new KeyListener(){
            ...
            public void keyPressed(KeyEvent e) {
                if(e.getKeyCode()==37){//Left
                    Object obj=jt.getValueAt(ballie.getRow(), ballie.getCol()-1);
                    if(BalliesWall.class.isInstance(obj)){
                        ...
                        try {
                            ...
                            Image image = ImageIO.read(new File(System.getProperty("user.dir") + "\\Images\\BalliesFloor.png"));
                            BalliesFloor bf = new BalliesFloor(bc.getRow(), bc.getCol(), image);                          
                    ...
                    Object obj=jt.getValueAt(ballie.getRow()-1, ballie.getCol());
                    if(BalliesWall.class.isInstance(obj)){
                        //Dont move on Wall                        
                    }else if(BalliesEnemy.class.isInstance(obj)){
                        //Die here
